...
namespace Kiper.Condominio.Data.Migrations
{
    ...
    [Migration("20190808033332_UpdateDocumentResidentTable")]
    partial class UpdateDocumentResidentTable
    {
            ...
            modelBuilder.Entity("Kiper.Condominio.Domain.Entities.Apartment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 8, 8, 0, 33, 32, 22, DateTimeKind.Local).AddTicks(3795));

                    b.Property<Guid>("CreatedBy");

                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 8, 8, 0, 33, 32, 23, DateTimeKind.Local).AddTicks(7990));
            ...
            modelBuilder.Entity("Kiper.Condominio.Domain.Entities.Condominium", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 8, 8, 0, 33, 31, 979, DateTimeKind.Local).AddTicks(7841));

                    b.Property<Guid>("CreatedBy");

                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 8, 8, 0, 33, 31, 989, DateTimeKind.Local).AddTicks(9468));
            ...
            modelBuilder.Entity("Kiper.Condominio.Domain.Entities.Resident", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 8, 8, 0, 33, 32, 38, DateTimeKind.Local).AddTicks(766));

                    b.Property<Guid>("CreatedBy");

                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 8, 8, 0, 33, 32, 38, DateTimeKind.Local).AddTicks(1514));
