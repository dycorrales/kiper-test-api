...
namespace Kiper.Condominio.Data.Migrations
{
    ...
    [Migration("20190808022258_UpdateCondominiumTable")]
    partial class UpdateCondominiumTable
    {
            ...
            modelBuilder.Entity("Kiper.Condominio.Domain.Entities.Apartment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 8, 7, 23, 22, 58, 328, DateTimeKind.Local).AddTicks(4275));

                    b.Property<Guid>("CreatedBy");

                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 8, 7, 23, 22, 58, 328, DateTimeKind.Local).AddTicks(5753));
            ...
            modelBuilder.Entity("Kiper.Condominio.Domain.Entities.Condominium", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 8, 7, 23, 22, 58, 289, DateTimeKind.Local).AddTicks(4869));

                    b.Property<Guid>("CreatedBy");

                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 8, 7, 23, 22, 58, 299, DateTimeKind.Local).AddTicks(6742));
            ...
            modelBuilder.Entity("Kiper.Condominio.Domain.Entities.Resident", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 8, 7, 23, 22, 58, 342, DateTimeKind.Local).AddTicks(4034));

                    b.Property<Guid>("CreatedBy");

                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 8, 7, 23, 22, 58, 342, DateTimeKind.Local).AddTicks(5269));
