...
namespace Kiper.Condominio.Data.Migrations
{
    ...
    [Migration("20190808022458_UpdateZipCodeCondominiumTable")]
    partial class UpdateZipCodeCondominiumTable
    {
            ...
            modelBuilder.Entity("Kiper.Condominio.Domain.Entities.Apartment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 8, 7, 23, 24, 57, 825, DateTimeKind.Local).AddTicks(7638));

                    b.Property<Guid>("CreatedBy");

                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 8, 7, 23, 24, 57, 825, DateTimeKind.Local).AddTicks(8278));
            ...
            modelBuilder.Entity("Kiper.Condominio.Domain.Entities.Condominium", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 8, 7, 23, 24, 57, 793, DateTimeKind.Local).AddTicks(2160));

                    b.Property<Guid>("CreatedBy");

                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 8, 7, 23, 24, 57, 801, DateTimeKind.Local).AddTicks(1902));
            ...
            modelBuilder.Entity("Kiper.Condominio.Domain.Entities.Resident", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 8, 7, 23, 24, 57, 835, DateTimeKind.Local).AddTicks(8464));

                    b.Property<Guid>("CreatedBy");

                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 8, 7, 23, 24, 57, 835, DateTimeKind.Local).AddTicks(9092));
