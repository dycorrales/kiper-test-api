...
namespace Kiper.Condominio.Data.Migrations
{
    ...
    [Migration("20190808003057_InitialCreate")]
            ...
            modelBuilder.Entity("Kiper.Condominio.Domain.Entities.Apartment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 8, 7, 21, 30, 56, 465, DateTimeKind.Local).AddTicks(1357));

                    b.Property<Guid>("CreatedBy");

                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 8, 7, 21, 30, 56, 465, DateTimeKind.Local).AddTicks(2453));
            ...
            modelBuilder.Entity("Kiper.Condominio.Domain.Entities.Condominium", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 8, 7, 21, 30, 56, 433, DateTimeKind.Local).AddTicks(1344));

                    b.Property<Guid>("CreatedBy");

                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 8, 7, 21, 30, 56, 440, DateTimeKind.Local).AddTicks(5548));
            ...
            modelBuilder.Entity("Kiper.Condominio.Domain.Entities.Resident", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 8, 7, 21, 30, 56, 475, DateTimeKind.Local).AddTicks(418));

                    b.Property<Guid>("CreatedBy");

                    b.Property<DateTime>("ModifiedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 8, 7, 21, 30, 56, 475, DateTimeKind.Local).AddTicks(920));
